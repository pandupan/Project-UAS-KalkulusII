...
const Riwayat = () => {
  ...
  useEffect(() => {
    const matrixOrdo2 = JSON.parse(localStorage.getItem("matrixOrdo2"));
    const determinanOrdo2 = JSON.parse(localStorage.getItem("determinanOrdo2"));

    if (matrixOrdo2) {
      setMatrixOrdo2(matrixOrdo2);
    }
    if (determinanOrdo2) {
      setDeterminanOrdo2(determinanOrdo2);
    }
  }, []);
