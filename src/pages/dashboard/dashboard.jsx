      ...
      <div className="sm:flex flex-wrap items-stretch justify-center text-center gap-8 mt-10">
                <div className="card w-80 my-10 text-gray-800 bg-white shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <Link to='/determinan2' className="btn btn-warning bg-[#E09132]">
                ...
                <div className="card w-80 my-10 text-gray-800 bg-white shadow-xl">
                    <figure><img src="https://i.ibb.co/23ydP9Y/Teacher-rafiki.png" alt="Math" /></figure>
                    <div className="card-body">
                        <h2 className="card-title">Kofaktor Ordo 2</h2>
                        <p className='mb-5'>Menampilkan Kalkulator Untuk Menyelesaikan Kofaktor Ordo 2</p>
                        <div className="card-actions  justify-end">
                        <Link className="btn btn-warning bg-[#E09132]" to='/kofaktor2'>
                ...
                <div className="card w-80 my-10 text-gray-800 bg-white shadow-xl">
                    <figure><img src="https://i.ibb.co/QjcyW3P/Teacher-cuate.png" alt="Math" /></figure>
                    <div className="card-body">
                        <h2 className="card-title">Adjoin Ordo2 </h2>
                        <p className='mb-5'>Menampilkan Kalkulator Untuk Menyelesaikan Adjoin Ordo 2</p>
                        <div className="card-actions  justify-end">
                        <Link className="btn btn-warning bg-[#E09132]"  to='/adjoin2'>
                ...
                <div className="card w-80 my-10 text-gray-800 bg-white shadow-xl">
                    <figure><img src="https://i.ibb.co/3C4kP9Y/Teaching-pana.png" alt="Math" /></figure>
                    <div className="card-body">
                        ...
                        <div className="card-actions  justify-end">
                        <Link className="btn btn-warning bg-[#E09132]" to='/determinan3'>
                ...
                <div className="card w-80 my-10 text-gray-800 bg-white shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions  justify-end">
                        <Link className="btn btn-warning bg-[#E09132]"  to='/kofaktor3'>
                ...
                <div className="card w-80 my-10 text-gray-800 bg-white shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <p className='mb-5'>Menampilkan Kalkulator Untuk Menyelesaikan Adjoin Ordo 3</p>
                        <div className="card-actions  justify-end">
                        <Link className="btn btn-warning bg-[#E09132]"  to='/adjoin3'>
                ...
                <div className="card w-80 my-10 text-gray-800 bg-white shadow-xl">
                    <figure><img src="https://i.ibb.co/hfmv779/Reading-list-bro.png" alt="Math" /></figure>
                    <div className="card-body">
                        <h2 className="card-title">Riwayat</h2>
                        <p className='mb-5'>Menampilkan Riwayat Dari Penggunaan Kalkulator Anda</p>
                        <div className="card-actions  justify-end">
                        <Link className="btn btn-warning bg-[#E09132]" to='/riwayat'>
                        <Link className='text-white' to='/riwayat'>Click Here  →</Link>
                        </Link>
                        </div>
                    </div>
                </div>
